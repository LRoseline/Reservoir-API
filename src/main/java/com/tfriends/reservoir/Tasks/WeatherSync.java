...
public class WeatherSync {
    ...
    public void WeatherRain(int a) throws Exception {
        ...
        // for (int a = 1; a < 28; a++) {
        WeatherVO vo = service.WeatherReady(a);

        String OnecallURL = "http://api.openweathermap.org/data/2.5/onecall?&lang=kr&units=metric&lat=" + vo.getLat()
                + "&lon=" + vo.getLon() + "&appid=" + setting.SettingLoad("openweathermap2").getValue();
